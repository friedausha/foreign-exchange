...
ActiveRecord::Schema.define(version: 2019_05_18_085719) do

  create_table "exchangeable_currencies", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "from"
    t.string "to"
